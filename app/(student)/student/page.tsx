...
export function LessonTypeBadge({ type }: { type: string }) {
  const map: Record<string, { label: string; className: string }> = {
    ...
    LAB_TASK: { label: "ЛЗ", className: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300" },
    LAB_GAME: { label: "ЛЗ-Игра", className: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300" },
    LAB_CODE: { label: "ЛЗ-Код", className: "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300" },
